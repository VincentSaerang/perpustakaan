<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            ...
            <?php if ($this->session->userdata('level') !== '0') { ?>
                ...
                <a href="<?= base_url("generate/books/$category->KategoriID") ?>" target="_blank"
                ...
                <a href="#" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal"
                    data-target="#addbookmodal"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Buku</a>
            <?php } ?>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?= $category->NamaKategori ?></li>
        </ol>
    </nav>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                                ...
                                <td class="w-fit-content">
                                    <?php if ($this->session->userdata('level') !== '0') { ?>
                                        <button class="btn btn-success" data-toggle="modal"
                                            data-target="#editbook<?= $cat['BukuID'] ?>"><i class="fas fa-edit"></i></button>
                                    <?php } ?>
                                    <a href="<?= base_url('book/view') ?>/<?= $cat['BukuID'] ?>" class="btn btn-primary"><i
                                            class="fas fa-eye"></i></a>
                                    <?php if ($this->session->userdata('level') !== '0') { ?>
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#delbook<?= $cat['BukuID'] ?>"><i class="fas fa-trash"></i></button>
                                    <?php } ?>
                                </td>
                            </tr>

                            <?php if ($this->session->userdata('level') !== '0') { ?>
                                <div class="modal fade" id="editbook<?= $cat['BukuID'] ?>" tabindex="-1" role="dialog"
                                            ...
                                            <form method="post" action="<?= base_url() ?>book/edit">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="bookyear" type="number" max="<?= $currentDate ?>"
                                                            class="form-control" value='<?= $cat["TahunTerbit"] ?>' required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-form-label">Stok:</label>
                                                        <input name="bookstok" type="number" class="form-control"
                                                            value="<?= $cat["Stok"] ?>" required>
                                                    </div>
                                                    <div class="form-group">
                ...
                <?php if ($this->session->userdata('level') !== '0') { ?>
                    <div class="modal fade" id="delbook<?= $cat['BukuID'] ?>" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">Kamu akan menghapus <strong><?= $cat['Judul'] ?></strong> dari
